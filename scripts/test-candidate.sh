...
case "${phase}" in
  unit)
    ...
    required+=',TestHTTPReadinessRejectsClosedRoles,TestShutdownWithdrawsReadinessAndDrainsAcceptedRPC,TestMembershipWithdrawalRetainsInFlightRequestSnapshot,TestAffinityRoutingKeepsPublishedHashMapping'
    ;;
